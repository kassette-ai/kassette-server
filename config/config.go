...
// bindEnv handles kassettes server's unique snake case replacement by registering
...
// Fallback environment variables supported (historically) by kassette-server
