...
2	Postgres	Destination	DBPolling	Database	https://www.postgresql.org	Write to Postgres relational Database	[{"name": "HOST", "type": "text", "keyID": "host"}, {"name": "Port", "type": "text", "keyID": "port"}, {"name": "Database", "type": "text", "keyID": "database"}, {"name": "User", "type": "text", "keyID": "user"}, {"name": "Password", "type": "text", "keyID": "password"}, {"name": "SSL Mode", "type": "text", "keyID": "ssl_mode"}, {"name": "Schema", "type": "schema", "keyID": "schema", "defaultValue": "{\\"table_name\\":\\"eventlog\\",\\"schema_fields\\":[{\\"name\\":\\"id\\",\\"type\\":\\"BIGSERIAL\\",\\"mode\\":\\"view\\",\\"primary_key\\":true},{\\"name\\":\\"payload\\",\\"type\\":\\"JSONB\\",\\"mode\\":\\"view\\",\\"primary_key\\":false},{\\"name\\":\\"received_at\\",\\"type\\":\\"TIMESTAMP\\",\\"mode\\":\\"view\\",\\"primary_key\\":false}]}"}, {"name": "Batch Size", "type": "text", "keyID": "batch_size"}]	static/icons/postgres.png
...
9	Anaplan	Destination	Rest	Workforce Planning	https://www.anaplan.com	Send Data to Anaplan for analysis	[{"name": "AuthUrl", "type": "url", "keyID": "authurl"}, {"name": "Username", "type": "text", "keyID": "username"}, {"name": "Password", "type": "text", "keyID": "password"}, {"name": "Url", "type": "url", "keyID": "url"}, {"name": "Method", "type": "method", "keyID": "method"}, {"name": "Query", "type": "json", "keyID": "query"}, {"name": "Header", "type": "json", "keyID": "header", "defaultValue": "{\\"Content-Type\\": \\"application/json\\"}"}]	static/icons/anaplan.png
